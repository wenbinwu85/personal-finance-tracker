...
class Dashboard():
    ...
    def __init__(self, panel, name, *args, **kwargs):
        ...
        dvlc = dv.DataViewListCtrl(self.panel, size=(1000, 300))
        dvlc.AppendTextColumn('Month', width=75, mode=dv.DATAVIEW_CELL_EDITABLE)
        ...
        canvas = plot.PlotCanvas(self.panel, 0, size=(1000, 230))
